...
const allowedOrigins = [process.env.CLIENT_URL, "http://localhost:5173"].filter((origin) => typeof origin === "string");
...
// Rate Limiter
app.use("/api/", rateLimit_middleware_1.sessionRateLimiter);
// Health Check
